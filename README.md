...
`ELSConfig` matches the base client — see [@inso_web/els-client](https://github.com/official-inso/els-client). The most relevant fields:
...
`ELSConfig` matches the base client — see [@inso_web/els-client](https://github.com/official-inso/els-client). `Logger` methods: `fatal` / `error` / `warn` / `info` / `debug` / `trace` / `child` / `flush`.
...
- [`@inso_web/els-next`](https://github.com/official-inso/els-next) — Next.js helpers (this repo)
